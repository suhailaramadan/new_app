...
class SettingsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> languageList = [AppLocalizations.of(context)!.english,AppLocalizations.of(context)!.arabic];
    return Padding(
        ...
        children: [
          Align(
            ...
            child: Text(AppLocalizations.of(context)!.lang,
              style: Theme.of(context)
                  .textTheme
                  .titleMedium
                  ?.copyWith(fontSize: 25,fontWeight: FontWeight.w600,color: AppTheme.primary),
            ),
          ),
          const SizedBox(
            height: 10,
          ...
          CustomDropdown<String>(
            decoration: CustomDropdownDecoration(
              hintStyle: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.grey),
            ...
            items: languageList,
            onChanged: (value) {
              return (settingsProvider.changeLang(value!));
            },
          )
        ],
      ),
